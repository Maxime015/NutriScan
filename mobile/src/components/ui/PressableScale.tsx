...
// `createAnimatedComponent` produit un composant tiers que NativeWind ne mappe pas
// automatiquement : sans ça, le `className` (ex. `w-full`) passé au wrapper est ignoré
// et les boutons se réduisent à la largeur de leur contenu.
